            ...
            <div className="max-w-7xl mx-auto space-y-6">
                <div className="flex items-center justify-between">
                    ...
                    <div className="text-right">
                        <div className="text-3xl font-bold text-white">₹{price.currentPrice.toLocaleString()}</div>
                    ...
                    <div className="lg:col-span-2 space-y-6">
                        ...
                        <div className={`p-4 rounded-lg border-l-4 ${recommendation.action === 'BUY' ? 'bg-green-900/20 border-green-500' :
                            ...
                            <div className="flex items-start">
                                <Lightbulb className={`h-5 w-5 mr-3 ${recommendation.action === 'BUY' ? 'text-green-400' :
                            ...
                            <div className="space-y-4">
                                {news.map((article, idx) => (
                                    <div key={idx} className="border-b border-gray-800 last:border-0 pb-4 last:pb-0">
                                        <a href={article.url} target="_blank" rel="noopener noreferrer" className="block hover:bg-gray-800 -mx-2 p-2 rounded transition-colors">
                                            <h4 className="text-sm font-bold text-gray-200">{article.title}</h4>
                        ...
                        <div className="bg-gray-900 border border-gray-800 shadow rounded-lg p-6">
                            ...
                            <dl className="grid grid-cols-1 gap-4 text-sm">
                                <div className="flex justify-between border-b border-gray-800 pb-2">
                                    ...
                                    <dd className="font-medium text-white">₹15.4T</dd>
                                </div>
                                <div className="flex justify-between border-b border-gray-800 pb-2">
                                    <dt className="text-gray-400">52W High</dt>
                                    <dd className="font-medium text-white">₹2,850</dd>
                                </div>
                                <div className="flex justify-between border-b border-gray-800 pb-2">
                                    <dt className="text-gray-400">52W Low</dt>
                                    <dd className="font-medium text-white">₹2,200</dd>
                                </div>
                                <div className="flex justify-between">
                                    <dt className="text-gray-400">P/E Ratio</dt>
                                    <dd className="font-medium text-white">24.5</dd>
                                </div>
                            </dl>
                        </div>
                    </div>
